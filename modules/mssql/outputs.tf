output "connection_string" {
  ...
  sensitive   = true
  value       = "Server=tcp:${azurerm_mssql_server.this[0].fully_qualified_domain_name},1433;Initial Catalog=${azurerm_mssql_database.this[0].name};Persist Security Info=False;User ID=${azurerm_mssql_server.this[0].administrator_login};Password=${azurerm_mssql_server.this[0].administrator_login_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
}
